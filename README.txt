...
commands for FAU201 Power Supply. The scripts included here are compatible
...
The package also includes a test script named "test.sh". This will set up
FAU201 so that it outputs a voltage of 2.048V. If the installation was
successful, this script should run without errors of any kind. Note that
"test.sh" doesn't require root permissions.
