/* FAU201 List Command - Version 1.1 for Debian Linux
    ...
    else  // If libusb is initialized
    {
        ...
        else
        {
            ...
            for (ssize_t i = 0; i < devlist; ++i)  // Run through all listed devices
            {
                ...
                if (libusb_get_device_descriptor(devs[i], &desc) == 0 && desc.idVendor == 0x10C4 && desc.idProduct == 0x8C46)  // If the device descriptor is retrieved, and both VID and PID correspond to the FAU201 Power Supply
                {
